            ...
            <div class="col-md-4">
                <div class="card h-100 shadow-sm border-0 hover-card" style="transition: transform 0.3s, box-shadow 0.3s;">
                    ...
                    <div class="card-body d-flex flex-column">
                        ...
                        <a href="#" class="btn" style="background-color: #6c9724; color: white; border-radius: 25px;">Agregar al carrito</a>
                    </div>
                </div>
            </div>
        @endforeach
...
<section class="text-center py-5 join-section">
    <h2 class="fw-bold mb-3">¡Únete a la revolución natural!</h2>
    <p class="mb-4">Cuida tu cabello de la manera que se merece. Orgánico, saludable y hermoso.</p>
    <a href="/registro" class="btn btn-light px-4 py-2 rounded-pill">Comenzar</a>
</section>
